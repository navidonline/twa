...
import 'package:twa/src/exceptions/exceptions.dart';
import 'package:twa/src/interop/js_object_wrapper.dart';
import 'package:twa/src/interop/web_app_interop.dart' as tele;
import 'package:twa/src/popup_button.dart';
import 'package:twa/src/utils/enums.dart';
import 'package:twa/src/utils/utils.dart';
...
class TeleWebApp extends JsObjectWrapper<tele.WebAppJsImpl> {
  ...
  CloudStorage get cloudStorage => CloudStorage.fromJsObject(jsObject.CloudStorage);

  SettingsButton get settingsButton => SettingsButton.fromJsObject(jsObject.SettingsButton);
...
/// It is responsible for controlling the cloud_storage.
///
/// Can be displayed in the header of the Mini App in the Telegram interface.
/// {@endtemplate}
class CloudStorage extends JsObjectWrapper<tele.CloudStorageJsImpl> {
  /// Wrap a JS object.
  ///
  /// {@macro cloud_storage}
  CloudStorage.fromJsObject(super.jsObject);
  ...
  void setItem(String key,String value,[void Function(String? error, [bool? stored])? callback]) =>
      jsObject.setItem(key,value,callback!=null ? allowInterop(callback):null);
  ...
  void getItem(String key,void Function(String? error, [String? result])? callback) =>
      jsObject.getItem(key,callback!=null ? allowInterop(callback):null);
  ...
  void getItems(List<String> keys,void Function(String? error, [List<String>? result])? callback) =>
      jsObject.getItems(keys,callback!=null ? allowInterop(callback):null);
  ...
  void removeItem(String key,void Function(String? error, [bool? removed])? callback) =>
      jsObject.removeItem(key,callback!=null ? allowInterop(callback):null);
  ...
  void removeItems(List<String> keys,void Function(String? error, [bool? removed])? callback) =>
      jsObject.removeItems(keys,callback!=null ? allowInterop(callback):null);
  ...
  void getKeys(void Function(String? error, [List<String>? keys]) callback) =>
      jsObject.getKeys(allowInterop(callback));
}
...
/// Can be displayed in the header of the Mini App in the Telegram interface.
/// {@endtemplate}
class SettingsButton extends JsObjectWrapper<tele.SettingsButtonJsImpl> {
  /// Wrap a JS object.
  ///
  /// {@macro settings_button}
  SettingsButton.fromJsObject(super.jsObject);
