...
abstract class WebAppJsImpl {
  ...
  external CloudStorageJsImpl get CloudStorage;
  external SettingsButtonJsImpl get SettingsButton;
...
@JS()
@anonymous
abstract class CloudStorageJsImpl {
  external factory CloudStorageJsImpl({
    void Function() setItem,
    void Function() getItem,
    void Function() getItems,
    void Function() removeItem,
    void Function() removeItems,
    void Function() getKeys,
  });

  external Future<void> setItem(String key,String value,[void Function(String? error, [bool? stored])? callback]);
  external Future<void> getItem(String key,void Function(String? error, [String? result])? callback);
  external Future<void> getItems(List<String> keys,void Function(String? error, [List<String>? result])? callback);
  external Future<void> removeItem(String key,void Function(String? error, [bool? removed])? callback);
  external Future<void> removeItems(List<String> keys,void Function(String? error, [bool? removed])? callback);
  external Future<void> getKeys(void Function(String? error, [List<String>? keys])? callback);
...
@JS()
@anonymous
abstract class SettingsButtonJsImpl {
  external factory SettingsButtonJsImpl({
    bool isVisible,
    void Function() onClick,
    void Function() offClick,
    void Function() show,
